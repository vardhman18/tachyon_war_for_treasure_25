...
export default function RuleSection() {
  ...
  const rules = [
  {
    ...
    description: "TEAM SIZE: 2–4 OPERATIVES REQUIRED. SOLO ENTRY: DENIED. ALL PARTICIPANTS MUST BE ONLINE AND READY FOR DEPLOYMENT BY 8TH NOVEMBER, 1 PM.",
  ...
  },
  {
    ...
    description: "THE ONLINE MISSION BEGINS AT 1 PM ON 8TH NOVEMBER. THE FASTEST TEAM TO COMPLETE ALL CHALLENGES FIRST WILL SECURE THE WIN. SPEED AND ACCURACY MAXIMIZE YOUR CHANCES OF VICTORY. SINGLE ROUND • SINGLE WINNING TEAM • PRIZE POOL ₹1000.",
